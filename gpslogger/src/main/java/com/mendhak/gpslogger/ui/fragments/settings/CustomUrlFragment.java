    ...
    public boolean onPreferenceClick(Preference preference) {
        if(preference.getKey().equals("customurl_legend_1")){
            ...
            String legend1 = MessageFormat.format("{0} %LAT<br />{1} %LON<br />{2} %DESC<br />{3} %SAT<br />{4} %ALT<br />" +
                            ...
                            "{10} %TIME<br />{11} %STARTTIMESTAMP<br />{12} %BATT<br />{13} %CHARG<br />{14} %AID<br />{15} %SER<br />" +
                            "{16} %ACT<br />{17} %FILENAME",
                    ...
                    getString(R.string.txt_battery), "Charging", "Android ID ", "Serial ", getString(R.string.txt_activity), getString(R.string.summary_current_filename));
